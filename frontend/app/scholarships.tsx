...
const ScholarshipsScreen: React.FC = () => {
  ...
  const items = [
    { id: 'merit', title: 'Merit-based Scholarships', subtitle: 'For outstanding academic performance' },
    { id: 'need', title: 'Need-based Scholarships', subtitle: 'Support based on financial need' },
    { id: 'sports', title: 'Sports Scholarships', subtitle: 'For exceptional athletes' },
    { id: 'women', title: 'Women in STEM', subtitle: 'Encouraging diversity in tech' },
  ];
